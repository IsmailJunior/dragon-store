...
export const FeatureCard = ( { title='title', heading='heading', price='00,00', image='https://i0.wp.com/roadmap-tech.com/wp-content/uploads/2019/04/placeholder-image.jpg?resize=400%2C400&ssl=1', invert, id, newTab=false}) =>
{
	return (
