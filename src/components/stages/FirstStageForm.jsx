...
const [ company, setCompany ] = useState( '' );
  ...
  return (
	...
	<div className='w-full my-10 flex flex-col'>
      ...
      <button disabled={!canSave ? true : false} className='w-44 h-10 disabled:bg-sky-300 hover:bg-sky-500 transition-all mb-2 bg-sky-600 text-white rounded-lg'>Next</button>
      </div>
	</>
  )
}
