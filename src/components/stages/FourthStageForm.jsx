	...
	<div className='flex flex-col'>
          ...
          <div className='flex flex-wrap gap-10  border p-4 rounded-lg my-4'>
            ...
            <div className='flex items-center gap-10 mt-5'>
              <button className='w-44 hover:bg-sky-500 transition-all my-4 bg-sky-600 text-white rounded'>Add Color</button>
      ...
      <button disabled={!canSaveColor ? true : false} className='w-44 h-10 hover:bg-sky-500 transition-all mb-2 bg-sky-600 text-white rounded-lg'>Next</button>
      </div>
	</>
  )
}
