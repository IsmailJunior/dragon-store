...
<div>
	...
	<span
	className={
		model ? 'shadow-inner shadow-gray-500 hover:outline-gray-300 outline outline-slate-100 block p-4 rounded-full border-2'
		: 'shadow-inner shadow-gray-500 block p-4 rounded-full border-2'					
