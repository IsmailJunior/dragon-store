...
export const FeatureBlockAdmin = ( { title, description , link, image, invert,onClick} ) =>
{
return (
<div onClick={onClick} className="cursor-pointer w-full h-96 bg-slate-200 flex justify-center items-center flex-col mb-3 relative">
